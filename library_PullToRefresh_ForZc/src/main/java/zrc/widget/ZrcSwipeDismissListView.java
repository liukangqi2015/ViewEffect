...
public class ZrcSwipeDismissListView extends ZrcListView
{
	...
	public ZrcSwipeDismissListView(Context context, AttributeSet attrs)
	{
		this(context, attrs, android.R.attr.listViewStyle);
	}

	public ZrcSwipeDismissListView(Context context, AttributeSet attrs, int defStyle)
	{
	...
	public void isRestoreHeight(boolean isRestoreHeight)
	{
		if (isRestoreHeight)
		{
			ViewHelper.setAlpha(mDownView, 1f);
			ViewHelper.setTranslationX(mDownView, 0);
			ViewGroup.LayoutParams lp = mDownView.getLayoutParams();
