...
public class PullToRefreshActivity extends AppCompatActivity implements PullToRefreshBase.OnRefreshListener2<ListView> {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case PULL_DOWN:
                    ...
                    break;
                case PULL_UP:
                    Toast.makeText(PullToRefreshActivity.this,"上拉加载",Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }
